...
class ImportaDadosEstacao:
    ...
    def __init__(self):
        self.proxyDict =  { "http"  : "http://54.207.45.19:3333", }
        self.colecao = []
        self.inter = 0
    ...
    def __GravaLog(self, codEstacao):
        ...
        STRING_LOG = 'Estac:{0}    Inicio:{1}    Fim:{2}    Tentativas:{3}    Tempo:{4}    QtdRegistros{5}'
...
if __name__ == "__main__":
    ...
    ARQUIVO_LOG = 'importadados.log'
    NOME_ARQUIVO = 'bases/saida{0}.json'
    QTD_REGISTROS_GRAVAR = 55555000
